...
enum HostCommand: Decodable {
    ...
    init(from decoder: Decoder) throws {
        ...
        case .appendWorkspaceDockIndicatorDebugLog:
            self = .appendWorkspaceDockIndicatorDebugLog(try AppendWorkspaceDockIndicatorDebugLog(from: decoder))
        case .runProcess:
...
enum HostEvent: Encodable {
    ...
    func encode(to encoder: Encoder) throws {
        ...
        case let .terminalCwdChanged(sessionId, cwd):
        ...
        case let .processResult(requestId, exitCode, stdout, stderr):
