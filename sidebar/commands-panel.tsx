...
export function CommandsPanel({
  ...
  const openCommandEditor = (command: SidebarCommandButton) => {
     ...
     * Action configuration must always use the full-window modal host. Missing
     * host is logged and thrown by openAppModal instead of falling back.
     */
    openAppModal({ commandDraft: draft, modal: "commandConfig", type: "open" });
  };
  ...
  useEffect(() => {
    ...
    setContextMenu(undefined);
    openCreateCommandEditor(createActionType ?? "terminal");
