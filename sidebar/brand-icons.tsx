...
/**
 * CDXC:SidebarBrandIcons 2026-05-06-18:55
 * Sidebar surfaces use local brand SVGs for product-specific actions so the
 * native webview renders the correct icon offline instead of substituting a
 * generic Tabler glyph.
 */
