...
describe("getTitleDerivedSessionActivity", () => {
  ...
  test("should detect Gemini working and ready titles", () => {
    ...
    expect(getTitleDerivedSessionActivity("✦ demo-project", workingActivity)).toEqual({
      activity: "working",
      agentName: "gemini",
      hasSeenWorking: true,
      isAcknowledged: false,
    ...
    expect(
      getTitleDerivedSessionActivity("◇ demo-project", {
        activity: "working",
        agentName: "gemini",
        hasSeenWorking: true,
        isAcknowledged: false,
  ...
  test("should allow a static Gemini working glyph to count as working", () => {
    expect(getTitleDerivedSessionActivity("✦ demo-project")).toEqual({
      activity: "working",
      agentName: "gemini",
      hasSeenWorking: true,
      isAcknowledged: false,
